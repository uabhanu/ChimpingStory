...
public class BhanuObjectsGenerator : MonoBehaviour
{
    ...
    public List<BhanuObjectsMover> m_bhanuObjectsMovers;                      //Holds the moving layer
    ...
    public BhanuParticles m_bhanuParticles;                         //A link to the particle player
    ...
    void Update()
    {
        ...
        if (!paused)
        {
            ...
            foreach (BhanuObjectsMover item in m_bhanuObjectsMovers)
            {
